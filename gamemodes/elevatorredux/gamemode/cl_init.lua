...
GM.CrosshairEnts = { "elevator_drink", "elevator_mediatv",
	"slotmachine",	"billiard_table", "billiard_static",
	"elevator_blender", "elevator_drink", "mediaplayer_tv",
	"elevator_media_cinema"

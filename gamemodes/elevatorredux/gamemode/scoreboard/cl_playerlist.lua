...
local ElevatorLogo = Material( "elevator/elevator_redux.vmt" )
...
local BluestoneIcon = Material( "elevator/bluestoneicon.png" )
...
function PLAYER:Paint( w, h )
	...
	elseif BluestoneDevs[ self.Player:SteamID() ] then

		surface.SetMaterial( BluestoneIcon )
		surface.DrawTexturedRect( self.Name.x + self.Name:GetWide() + 5, self.Name.y + 3, 40, 16 )

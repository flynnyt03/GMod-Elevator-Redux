...
function guiBilliardClientConfig()
	...
	b_client_panel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(0,0,0,235))
		draw.RoundedBox(0,0,0,w,25,Color(0,0,0,235))
	end
	...
	MSPanel.Paint = function(self, w, h)
	...
	CIHPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	CIVPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	IHPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	IVPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
...
usermessage.Hook("billiard_setConfig", function(um)
	...
	AbModeBox:SetTextColor(Color(255, 255, 255))
	if(abmet == 0) then
	...
	gTLabel:SetTextColor(Color(255, 255, 255))
	...
	bTLabel:SetTextColor(Color(255, 255, 255))
	...
	FpModeBox:SetTextColor(Color(255, 255, 255))
	...
	ScModeBox:SetTextColor(Color(255, 255, 255))
	...
	TrModeBox:SetTextColor(Color(255, 255, 255))
	...
	MpModeBox:SetTextColor(Color(255, 255, 255))
...
function guiRequestPlayer()
	...
	b_requests_panel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(0,0,0,235))
		draw.RoundedBox(0,0,0,w,25,Color(0,0,0,235))
	end
	...
	GridList.Paint = function(self, w, h)
	...
	AccButn:SetTextColor(Color(255,255,255))
	AccButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	RefButn:SetTextColor(Color(255,255,255))
	RefButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end	
	...
	RandButn:SetTextColor(Color(255,255,255))
	RandButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end		
	...
	RefAButn:SetTextColor(Color(255,255,255))
	RefAButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end			
	...
	ClButn:SetTextColor(Color(255,255,255))
	ClButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end		
...
usermessage.Hook("billiard_createMenu", function(um)
	...
	BPanelTitle:SetPos(10, 5)
	BPanelTitle:SetText("Advanced Options")
	BPanelTitle:SetTextColor(Color(255, 255, 255))
	BPanelTitle:SetDark(true)
	BPanelTitle:SizeToContents()
	...
	bTPanel:SetPos(10, 129)
	bTPanel:SetSize(267, 24)
	bTPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	szLabel:SetTextColor(Color(255, 255, 255))
	...
	TrPanel:SetSize(131, 20)
	TrPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	ScPanel:SetSize(131, 20)
	ScPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	MpPanel:SetSize(131, 20)
	MpPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	FpPanel:SetSize(131, 20)
	FpPanel.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	dfButton:SetColor(Color(255,255,255))
	dfButton.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	spButton:SetColor(Color(255,255,255))
	spButton.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	spButton.DoClick = function()
...
usermessage.Hook("billiard_promptExit", function(um)
	...
	MainFrame.Paint = function(self, w, h)
	draw.RoundedBox(0,0,0,w,h,Color(0,0,0,235))
	draw.RoundedBox(0,0,0,w,25,Color(50,50,50,235))
	end
	...
	ExitButn:SetColor(Color(255,255,255))
	ExitButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
	...
	CButn:SetColor(Color(255,255,255))
	CButn.Paint = function(self, w, h)
		draw.RoundedBox(0,0,0,w,h,Color(100,100,100,100))
	end
